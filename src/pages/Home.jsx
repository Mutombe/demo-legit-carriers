      ...
      {[...Array(14)].map((_, i) => (
        <div
          ...
          style={{
            ...
            height: '1px',
            background: `linear-gradient(90deg, transparent, rgba(34,197,94,${Math.random() * 0.35 + 0.1}), transparent)`,
            left: `${Math.random() * 100}%`,
            top: `${Math.random() * 100}%`,
            animation: `speed-streak ${Math.random() * 4 + 3}s linear infinite`,
...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      <div className="absolute top-[10%] left-0 w-[3px] h-40 sm:h-56 bg-gradient-to-b from-transparent via-green-500 to-transparent z-20" />
      ...
      >
        ...
        <motion.div
          ...
          className="w-20 h-[3px] bg-gradient-to-r from-green-500 to-green-400/50 mb-6 origin-left"
        />
        ...
        <div className="overflow-hidden">
          {['FAST.', 'RELIABLE.', 'ON TIME.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                className={`font-heading leading-[0.92] tracking-tight ${
                  line === 'RELIABLE.'
                    ? 'bg-gradient-to-r from-green-500 via-green-400 to-emerald-400 bg-clip-text text-transparent'
                    : 'text-white'
                }`}
                style={{
                  fontSize: 'clamp(2.2rem, 7vw, 4.5rem)',
                  fontWeight: line === 'RELIABLE.' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-green-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-green-400 hover:shadow-xl hover:shadow-green-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
...
function RouteTrackingStrip() {
  const routes = ['HARARE', 'BULAWAYO', 'MUTARE', 'MASVINGO', 'GWERU', 'BEITBRIDGE', 'CHIRUNDU', 'LUSAKA', 'MAPUTO'];
      ...
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-green-500/80 font-heading text-lg sm:text-2xl tracking-wider uppercase font-semibold">
              {item}
            </span>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Move</p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-green-500/10 font-heading text-6xl sm:text-7xl leading-none font-bold">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  {/* Green icon badge — filled */}
                  <div className="absolute top-5 left-5 z-10 w-10 h-10 bg-green-500/20 border border-green-500/30 flex items-center justify-center group-hover:bg-green-500/30 group-hover:border-green-500/60 transition-all duration-500">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-green-500 to-emerald-400 z-10" />
                </Link>
              </motion.div>
            );
          })}
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-green-500 mb-6" />
            <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Fleet</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Built to <span className="text-green-500">Deliver</span>
            </h2>
          </div>
          <Link
            to="/projects"
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-green-500/90 text-navy-950 text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-green-500 leading-none font-bold"
    ...
    <section ref={ref} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="w-12 h-[3px] bg-green-500 mb-6" />
            <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>About Us</p>
            <h2 className="font-heading text-white leading-[0.95] mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              Moving Zimbabwe<br />
              <span className="text-green-500">Forward</span>
            </h2>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-green-500 font-heading text-3xl sm:text-4xl leading-none font-bold">{business.established}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-green-500 font-heading text-3xl sm:text-4xl leading-none font-bold">{business.projectsCompleted}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Deliveries</div>
              </div>
              <div>
                <div className="text-green-500 font-heading text-3xl sm:text-4xl leading-none font-bold">99%</div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-green-500 text-navy-950 p-5 sm:p-7 shadow-2xl">
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'GPS-Tracked Fleet', desc: 'Real-time visibility on every shipment. Know where your cargo is, every step of the journey.' },
    { title: 'Cross-Border Expertise', desc: 'Licensed clearing agents for Zimbabwe, South Africa, Zambia, and Mozambique corridors.' },
    { title: 'Same-Day Express', desc: 'Urgent parcels within Harare delivered the same day, guaranteed.' },
    { title: 'Secure Warehousing', desc: 'Climate-controlled storage facilities with 24/7 security and inventory management systems.' },
  ];
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="w-12 h-[3px] bg-green-500 mb-6" />
            <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>The Advantage</p>
            <h2 className="font-heading text-white leading-[0.95] mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-green-500">{business.name}</span>
            </h2>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-6 mt-12">
            <button onClick={prev} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-green-500 hover:border-green-500/30 transition-colors duration-300" aria-label="Previous testimonial">
              <CaretLeft size={16} />
            </button>
            <div className="flex gap-2">
              {homeTestimonials.map((_, i) => (
                <button key={i} onClick={() => setActive(i)} className={`h-[2px] transition-all duration-500 ${i === active ? 'w-10 bg-green-500' : 'w-3 bg-white/10 hover:bg-white/25'}`} aria-label={`Go to testimonial ${i + 1}`} />
              ))}
            </div>
            <button onClick={next} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-green-500 hover:border-green-500/30 transition-colors duration-300" aria-label="Next testimonial">
              <CaretRight size={16} />
            </button>
          </div>
        </motion.div>
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          ...
          >
            YOUR CARGO<br />
            <span className="text-green-500">OUR COMMITMENT</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-green-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-green-400 hover:shadow-xl hover:shadow-green-500/25"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
